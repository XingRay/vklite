...
namespace vklite {
    ...
    public:
        ...
        PhysicalDeviceSelector& asDefault();

        PhysicalDeviceSelector& supportSurface(const Surface& surface);

        PhysicalDeviceSelector& supportQueueFlags(vk::QueueFlags queueFlags);
