...
namespace vklite {
    class WindowsGlfwSurfacePlugin : public PluginInterface {
    private:

    public:
        explicit WindowsGlfwSurfacePlugin();

        ~WindowsGlfwSurfacePlugin() override;
    ...
    public: // static
        static std::unique_ptr<WindowsGlfwSurfacePlugin> buildUnique();
    };
} // vklite
